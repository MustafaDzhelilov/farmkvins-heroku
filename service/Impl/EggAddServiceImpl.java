...
public class EggAddServiceImpl implements EggAddService {
    ...
    public void add(EggServiceModel eggServiceModel) {
        ...
        if(eggServiceModel.getEgg() == CategoryEggEnum.L || eggServiceModel.getEgg() == CategoryEggEnum.M
        || eggServiceModel.getEgg() == CategoryEggEnum.S &&
        eggServiceModel.getCartons() != CategoryCartonsEnum.CARTONS_180_WHITE || eggServiceModel.getCartons() != CategoryCartonsEnum.CARTONS_180_BROWN
        || eggServiceModel.getCartons() != CategoryCartonsEnum.CARTONS_360_BROWN ||
                eggServiceModel.getCartons() != CategoryCartonsEnum.COREY_30_HARTMAN ||
                eggServiceModel.getCartons() != CategoryCartonsEnum.COREY_30_CHEZ ||
                eggServiceModel.getCartons() != CategoryCartonsEnum.COREY_30_FAMILY ||
                eggServiceModel.getCartons() != CategoryCartonsEnum.COREY_30_EURO ||
                eggServiceModel.getCartons() != CategoryCartonsEnum.COREY_UKRAYNA ||
        ...
        if(isZero == 1 && equalTypeCarton == 0 && wrongCoreyInXL == 0) {
